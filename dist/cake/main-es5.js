...
var AdminComponent = /** @class */ (function () {
    ...
    AdminComponent.prototype.NewsRegister = function () {
    ...
    //     //   });
    // }
    AdminComponent.prototype.CakesRegister = function () {
...
var OffersPageComponent = /** @class */ (function () {
    function OffersPageComponent(http) {
        this.http = http;
    }
    OffersPageComponent.prototype.OffersUpdate = function () {
    };
    OffersPageComponent.prototype.OffersDelete = function () {
    };
    OffersPageComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var OffersregComponent = /** @class */ (function () {
    function OffersregComponent(http) {
        this.http = http;
        this.selectedFile = null;
    }
    OffersregComponent.prototype.ngOnInit = function () { };
    OffersregComponent.prototype.selectedImage = function (event) {
        // console.log(event);
        if (event.target.files.length > 0) {
            this.selectedFile = event.target.files[0];
        }
    };
    OffersregComponent.prototype.Offersreg = function (form) {
        ...
        this.http.post('http://localhost:3000/api/user/offersregister', offerdata).subscribe(function () {
            // console.log('news runing');
        }, function (error) {
            console.log(error);
        });
    };
    OffersregComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
/* harmony import */ var _angular_fire__WEBPACK_IMPORTED_MODULE_76__ = __webpack_require__(/*! @angular/fire */ "./node_modules/@angular/fire/index.js");
/* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_77__ = __webpack_require__(/*! @angular/fire/firestore */ "./node_modules/@angular/fire/firestore/index.js");
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.createUser = function (fname, lname, email, pass, cpass) {
        var _this = this;
    ...
    AuthService.prototype.login = function (emal, pass) {
        var _this = this;
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.LoginForm = function (form) {
        if (form.invalid) {
            return;
        }
        this.isLoading = true;
...
var Birthday1st25th50thComponent = /** @class */ (function () {
    function Birthday1st25th50thComponent() {
    }
    Birthday1st25th50thComponent.prototype.ngOnInit = function () { };
    ...
    return Birthday1st25th50thComponent;
}());
...
var BirthdaycakesComponent = /** @class */ (function () {
    function BirthdaycakesComponent() {
    }
...
var CameracakesComponent = /** @class */ (function () {
    function CameracakesComponent() {
    }
...
var CartooncharcakesComponent = /** @class */ (function () {
    function CartooncharcakesComponent() {
    }
    ...
    return CartooncharcakesComponent;
}());
...
var CrowntiaracakesComponent = /** @class */ (function () {
    function CrowntiaracakesComponent() {
    }
    ...
    return CrowntiaracakesComponent;
}());
...
var DisneyPrincesscakesComponent = /** @class */ (function () {
    function DisneyPrincesscakesComponent() {
    }
    ...
    return DisneyPrincesscakesComponent;
}());
...
var HarwaretoolcakesComponent = /** @class */ (function () {
    function HarwaretoolcakesComponent() {
    }
    ...
    return HarwaretoolcakesComponent;
}());
...
var JamesBondcakesComponent = /** @class */ (function () {
    function JamesBondcakesComponent() {
    }
    ...
    return JamesBondcakesComponent;
}());
...
var SuperheroescakesComponent = /** @class */ (function () {
    function SuperheroescakesComponent() {
    }
    ...
    return SuperheroescakesComponent;
}());
...
var VideogamecakesComponent = /** @class */ (function () {
    function VideogamecakesComponent() {
    }
    ...
    return VideogamecakesComponent;
}());
...
var CakescategoryregComponent = /** @class */ (function () {
    function CakescategoryregComponent(http) {
        this.http = http;
        this.selectedFile = null;
    }
    CakescategoryregComponent.prototype.ngOnInit = function () { };
    CakescategoryregComponent.prototype.selectedImage = function (event) {
        // console.log(event);
        if (event.target.files.length > 0) {
            this.selectedFile = event.target.files[0];
        }
    };
    CakescategoryregComponent.prototype.Cakesreg = function (form) {
        var cakecatdata = new FormData();
        ...
        this.http.post('http://localhost:3000/api/user/cakesregister', cakecatdata).subscribe(function () {
            // console.log('news runing');
        }, function (error) {
            console.log(error);
        });
    };
    CakescategoryregComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
    ...
    return CakescategoryregComponent;
}());
...
var CakeformComponent = /** @class */ (function () {
    function CakeformComponent(formBuilder, fb, router, cartservice) {
    ...
    CakeformComponent.prototype.ngOnInit = function () { };
    CakeformComponent.prototype.processForm = function (form) {
        if (form.valid) {
            var data = {
    ...
    Object.defineProperty(CakeformComponent.prototype, "f", {
        // convenience getter for easy access to form fields
        get: function () { return this.registerForm.controls; },
        enumerable: true,
        configurable: true
    });
    CakeformComponent.prototype.onSubmit = function () {
        this.submitted = true;
    ...
    CakeformComponent.ctorParameters = function () { return [
...
var CartService = /** @class */ (function () {
    ...
    CartService.prototype.StoreAllCakeDetails = function (data) {
    ...
    CartService.prototype.getSelectedIndex = function (id) {
        for (var i = 0; i < this.cakedetail.length; i++) {
...
var CakesregComponent = /** @class */ (function () {
    function CakesregComponent(http) {
        this.http = http;
        this.selectedFile = null;
    }
    CakesregComponent.prototype.ngOnInit = function () { };
    CakesregComponent.prototype.selectedImage = function (event) {
        // console.log(event);
        if (event.target.files.length > 0) {
            this.selectedFile = event.target.files[0];
        }
    };
    CakesregComponent.prototype.Offersreg = function (form) {
        var cakedata = new FormData();
        ...
        this.http.post('http://localhost:3000/api/user/cakesregister', cakedata).subscribe(function () {
            console.log('news runing');
        }, function (error) {
            console.log(error);
        });
    };
    CakesregComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var CartComponent = /** @class */ (function () {
    function CartComponent(activatedRoute, cartService) {
...
var BoatcakesComponent = /** @class */ (function () {
    function BoatcakesComponent() {
    }
...
var CorporatecakesComponent = /** @class */ (function () {
    function CorporatecakesComponent() {
    }
    ...
    return CorporatecakesComponent;
}());
...
var DoctorcakesComponent = /** @class */ (function () {
    function DoctorcakesComponent() {
    }
...
var FootballclubscakesComponent = /** @class */ (function () {
    function FootballclubscakesComponent() {
    }
    ...
    return FootballclubscakesComponent;
}());
...
var LawyercakesComponent = /** @class */ (function () {
    function LawyercakesComponent() {
    }
...
var MusiceqcakesComponent = /** @class */ (function () {
    function MusiceqcakesComponent() {
    }
...
var PokercasinocakesComponent = /** @class */ (function () {
    function PokercasinocakesComponent() {
    }
    ...
    return PokercasinocakesComponent;
}());
...
var ReligiousthemecakesComponent = /** @class */ (function () {
    function ReligiousthemecakesComponent() {
    }
    ...
    return ReligiousthemecakesComponent;
}());
...
var SafaejunglecakesComponent = /** @class */ (function () {
    function SafaejunglecakesComponent() {
    }
    ...
    return SafaejunglecakesComponent;
}());
...
var WatchbrandscakesComponent = /** @class */ (function () {
    function WatchbrandscakesComponent() {
    }
    ...
    return WatchbrandscakesComponent;
}());
...
var NewsregComponent = /** @class */ (function () {
    function NewsregComponent(http) {
        this.http = http;
        this.selectedFile = null;
    }
    NewsregComponent.prototype.ngOnInit = function () { };
    NewsregComponent.prototype.selectedImage = function (event) {
        // console.log(event);
        if (event.target.files.length > 0) {
            this.selectedFile = event.target.files[0];
        }
    };
    NewsregComponent.prototype.Newsreg = function (form) {
        var fd = new FormData();
        /*const payload = new HttpParams()
        .set('Heading', form.value.heading)
        .set('Subheading', form.value.subheading )
        ...
        this.http.post('http://localhost:3000/api/user/newsregister', fd).subscribe(function () {
            // console.log('news runing');
        }, function (error) {
            console.log(error);
        });
    };
    NewsregComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var BabyshowerComponent = /** @class */ (function () {
    function BabyshowerComponent() {
    }
...
var FathersDayComponent = /** @class */ (function () {
    function FathersDayComponent() {
    }
...
var MothersDayComponent = /** @class */ (function () {
    function MothersDayComponent() {
    }
...
var NewYearComponent = /** @class */ (function () {
...
var OurcakesComponent = /** @class */ (function () {
    function OurcakesComponent() {
    }
...
var ValentinesDayComponent = /** @class */ (function () {
    function ValentinesDayComponent() {
    }
...
var AlcoholthemecakesComponent = /** @class */ (function () {
    function AlcoholthemecakesComponent() {
    }
    ...
    return AlcoholthemecakesComponent;
}());
...
var ComicthemecakesComponent = /** @class */ (function () {
    function ComicthemecakesComponent() {
    }
    ...
    return ComicthemecakesComponent;
}());
...
var DogshapedcakesComponent = /** @class */ (function () {
    function DogshapedcakesComponent() {
    }
    ...
    return DogshapedcakesComponent;
}());
...
var NumbershapedcakesComponent = /** @class */ (function () {
    function NumbershapedcakesComponent() {
    }
    ...
    return NumbershapedcakesComponent;
}());
...
var PersonalizedcakesComponent = /** @class */ (function () {
    function PersonalizedcakesComponent() {
    }
    ...
    return PersonalizedcakesComponent;
}());
...
var AllcakesComponent = /** @class */ (function () {
    function AllcakesComponent() {
    }
...
var BaptismcakesComponent = /** @class */ (function () {
    function BaptismcakesComponent() {
    }
...
var ChristmascakesComponent = /** @class */ (function () {
    function ChristmascakesComponent() {
    }
    ...
    return ChristmascakesComponent;
}());
...
var EastercakesComponent = /** @class */ (function () {
    function EastercakesComponent() {
    }
...
var GenderrevcakesComponent = /** @class */ (function () {
    function GenderrevcakesComponent() {
    }
    ...
    return GenderrevcakesComponent;
}());
...
var GraduationcakesComponent = /** @class */ (function () {
    function GraduationcakesComponent() {
    }
    ...
    return GraduationcakesComponent;
}());
...
var HousewarmingcakesComponent = /** @class */ (function () {
    function HousewarmingcakesComponent() {
    }
    ...
    return HousewarmingcakesComponent;
}());
...
var SpecialcakesComponent = /** @class */ (function () {
    function SpecialcakesComponent() {
    }
...
var JerseyshapedcakesComponent = /** @class */ (function () {
    function JerseyshapedcakesComponent() {
    }
    ...
    return JerseyshapedcakesComponent;
}());
...
var OthersportsandgamescakesComponent = /** @class */ (function () {
    function OthersportsandgamescakesComponent() {
    }
    ...
    return OthersportsandgamescakesComponent;
}());
...
var FootballcakesComponent = /** @class */ (function () {
    function FootballcakesComponent() {
    }
...
var Formula1cakesComponent = /** @class */ (function () {
    function Formula1cakesComponent() {
    }
...
var GolfcakesComponent = /** @class */ (function () {
    function GolfcakesComponent() {
    }
...
var GymcakesComponent = /** @class */ (function () {
    function GymcakesComponent() {
    }
...
var SportscakesComponent = /** @class */ (function () {
    function SportscakesComponent() {
    }
...
var TenniscakesComponent = /** @class */ (function () {
    function TenniscakesComponent() {
    }
